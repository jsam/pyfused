...
from pyfused.core.abc import EngineAPI, NetworkAPI, NetworkPlotAPI
from pyfused.core.engines import SerialEngine
from pyfused.core.nodes import (
    DataNode,
    GearInput,
    GearInputOutput,
    GearNode,
...
class Depends(Generic[T]):
    ...
    def __init__(self, func: Callable[..., Any]) -> None:
        ...
        from pyfused.core.nodes import GearNode
